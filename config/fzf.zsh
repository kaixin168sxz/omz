...
zstyle ':fzf-tab:complete:(kill|ps|killall):argument-rest' fzf-preview '[ "$group" = "process ID" ] && ps --pid=$word -o cmd --no-headers -w -w'
zstyle ':fzf-tab:complete:(kill|ps|killall):argument-rest' fzf-flags --preview-window=down:3:wrap
